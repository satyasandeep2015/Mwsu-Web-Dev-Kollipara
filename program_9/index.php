...
(function($) {
    ...
    */
    ...
    function loadTableData(page, page_size,sort,order) {
		...
		console.log("https://webdevkollipara.xyz/api/api.php/products?order="+sort+order+"&page=" + page + "," + page_size);
        $.get("https://webdevkollipara.xyz/api/api.php/products?order="+sort+order+"&page=" + page + "," + page_size)
    ...
    function getTotalPages(){
        $.get("https://webdevkollipara.xyz/program_9/total_pages.txt")
	...
	$('#search-btn').click(function(event){
		...
		url="https://webdevkollipara.xyz/api/api.php/products?&filter[]=desc,cs," + key + "&satisfy=any" ;
		//$('#search-btn').html
		console.log(url);

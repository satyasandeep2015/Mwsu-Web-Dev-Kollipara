...
if(isset($_POST['register']))
{
 ...
 if( ($fname== null or $lname== null or $uname== null or $email==null or $pass1== null or $pass2== null))
 {
     $msg= " All fields are mandatory";
  /* $msg = "<div class='error'>
		  <span class='glyphicon glyphicon-info-sign'></span> &nbsp; All fields must be entered !
		 </div>"; */
 }
 if($pass1 != $pass2){
 //do something
